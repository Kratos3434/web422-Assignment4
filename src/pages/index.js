...
* 
*  Name: Keith Carlos Student ID: 127638211 Date: ____________________
*
********************************************************************************/ 
...
export default function Home() {
    return (
        <>
            ...
            <img src="https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg" fluid height={500} width={1300}/>
            <br /><br />
            <Row>
                <Col md={6}>
                ...
                <Col md={6}>
                    ...
                    <a href="https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art" target="_blank" rel="noreferrer">
                        The Metropolitan Museum of Art in New York City Wiki
                    </a>
                </Col>
            </Row>
        </>
